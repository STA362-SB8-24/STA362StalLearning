---
title: "STA 362 - Introduction to Statistical Learning"
...
Instructor [Dr. Tyler George](https://stats-tgeorge.github.io/personal_website/about.html)

`r fontawesome::fa('university')` &nbsp; Cornell College, West 311

`r fontawesome::fa('envelope')` &nbsp; <a href="mailto:tgeorge@cornellcollege.edu"> tgeorge\@cornellcollege.edu </a>
...
`r fontawesome::fa("calendar-alt")` &nbsp; [Course Calendar](https://calendar.google.com/calendar/u/0?cid=Y19hMDllY2RmYTIyMjMyMTY1YWQwNTE0YjI0Y2FmNjMyMWM1N2YwY2M3MjExNmQ2MjAxMzQxZDdlMTFmZTZiZTUwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20)
...
`r fontawesome::fa("calendar")` &nbsp; Moday - Friday

`r fontawesome::fa("clock")` &nbsp; 3:05pm-4:05pm

`r fontawesome::fa("location-dot")` &nbsp; West 311

:::

:::

I am available far beyond these times listed. Please email me and we can set up a time to chat about class material or whatever you prefer! I will generally announce changes to office hours in class but I still suggest checking the [Course Calendar](https://calendar.google.com/calendar/u/0?cid=Y19hMDllY2RmYTIyMjMyMTY1YWQwNTE0YjI0Y2FmNjMyMWM1N2YwY2M3MjExNmQ2MjAxMzQxZDdlMTFmZTZiZTUwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20) to verify availability. 
...
- Our book is [Data Science in a Box](https://datasciencebox.org/) by Mine Çetinkaya-Rundel. This book is a fabulous book for both R and version control (our major topics). 
Our secondary books are:
